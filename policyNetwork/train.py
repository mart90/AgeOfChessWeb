...
def train_epoch(model, dataloader, optimizer, device):
    ...
    return acc, total_loss / total_samples if total_samples > 0 else 0.0
...
def evaluate(model, dataloader, device):
    ...
    acc = total_correct / total_samples if total_samples > 0 else 0.0
    return total_loss / total_samples if total_samples > 0 else 0.0, acc
...
def run_training(board_tensors, move_indices, device, game_ids=None,
